    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_group', models.CharField(blank=True, help_text='User group (15 characters max)', max_length=15)),
                ('activity_date', models.DateField(blank=True, help_text='Date of current activity', null=True)),
